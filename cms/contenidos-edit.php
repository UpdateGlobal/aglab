...
if($proceso==""){
  ...
  if($cod_contenido==5 || $cod_contenido==7 || $cod_contenido==8){
        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <?php } ?>
              <?php if($cod_contenido==5 || $cod_contenido==7 || $cod_contenido==8){ ?>
              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  <label class="col-form-label" for="logo">Imagen:</label><br>
                  <small><?php if($cod_contenido==5){ echo "(282px x 96px)"; }; if($cod_contenido==7){ echo "(500px x 500px)"; }; ?></small>
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-8 col-lg-10">
                  ...
                  <input class="form-control" name="contenido" id="contenido" <?php if($xVisitante=="1"){ ?> style="display:none;" <?php }else{ ?> <?php } ?> value="<?php echo $contenido; ?>" />
                </div>
              </div>
              <?php } ?>
              <?php if($cod_contenido==10 || $cod_contenido==9){ ?>
              ...
              <div class="form-group row">
                ...
                <div class="col-8 col-lg-10">
                  <?php if($xVisitante=="1"){ ?><p><?php echo $contenido; ?></p><?php } ?>
                  <textarea id="contenido" name="contenido" data-provide="summernote" data-min-height="150" <?php if($xVisitante=="1"){ ?> style="display:none;" <?php }else{ ?> <?php } ?> ><?php echo $contenido; ?></textarea>
                </div>
              </div>
              <?php } ?>
              <div class="form-group row">
