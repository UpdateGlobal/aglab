	...
	<div class="container pad-top60px pad-bottom60px">
		...
		<div class="row">
			...
			<div class="col-md-6 col-xs-12">
	            ...
	            <div class="flat-tabs">
	                <ul class="menu-tabs">
	                    <li class="active"><a href="about.html#">Safety</a></li>
...
<hr>
	...
	<div class="container pad-top60px pad-bottom60px">
		<div class="row" align="center">
			<h2 class="flat-title-section_nosotros  mag-bottom0px">Loren  <span class="scheme2">Ipsum</span>Text</h2>
		</div>
		<div class="row">
			<div class="col-md-6 col-xs-12">
			...
			<div class="col-md-6 col-xs-12">
				...
				<img src="images/services/s14.jpg" class="img-responsive pad-top60px pad-bottom60px">
			</div>
		</div>
	</div>
