				...
				<div class="col-md-8 col-xs-12">
					...
					<div class="general">
		            	<div class="woocommerce">
		                	<ul class="products">
		                		<?php
                                    $consultarProductos = "SELECT * FROM productos WHERE estado='1' AND sector_3='1'";
                                ...
                                <?php
                                        ...
                                        $consultarProductos = "SELECT * FROM productos WHERE estado='1' AND sector_3='1' ORDER BY orden ASC $limite";
			                			$resultadoProductos = mysqli_query($enlaces, $consultarProductos);
