	                ...
	                <div class="flat-wrapper">
	                    <div class="breadcrumbs">
	                        ...
	                        <ul class="trail-items">
	                            ...
	                            <li>Sector Hoteles y Restaurantes</li>
	                        </ul>
	                    </div><!-- /.breadcrumbs -->
	                </div><!-- /.flat-wrapper -->
	            </div><!-- /.row -->
				...
				<div class="col-md-8 col-xs-12">
					...
					<div class="general">
		            	<div class="woocommerce">
		                	<ul class="products">
		                		<?php
                                    $consultarProductos = "SELECT * FROM productos WHERE estado='1' AND sector_4='1'";
                                ...
                                <?php
                                        ...
                                        $consultarProductos = "SELECT * FROM productos WHERE estado='1' AND sector_4='1' ORDER BY orden ASC $limite";
			                			$resultadoProductos = mysqli_query($enlaces, $consultarProductos);
